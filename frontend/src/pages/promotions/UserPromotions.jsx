...
const STATUS_OPTIONS = [
  ...
  { value: "upcoming", label: "Not yet started" },
...
// status code helper
function getPromotionStatusCode(startTime, endTime) {
...
//human-readable label built from code
function getPromotionStatusLabel(startTime, endTime) {
  const code = getPromotionStatusCode(startTime, endTime);
  if (code === "upcoming") return "Not yet started";
...
export default function UserPromotions() {
  ...
  // Filter promotions on the current page by status
  const filteredPromotions = promotions.filter((promo) => {
    if (!statusFilter) return true; 
    const code = getPromotionStatusCode(promo.startTime, promo.endTime);
  ...
  return (
    <div className="page page-promotions md:px-16">
      ...
      <div className="page-header flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-semibold mb-1">Available Promotions</h1>
        </div>
      </div>
      ...
      <div className="card p-0 rounded-2xl bg-white shadow-sm">
        {loading ? (
          ...
          <div className="px-6 py-8 text-center text-gray-500 text-sm">
            No promotions available for this filter.
          </div>
        ) : (
          <>
